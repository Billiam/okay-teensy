...
static const AudioSynthWavetable::sample_data Clarinet_samples[6] = {
	{
		...
		uint32_t(3059.58 * AudioSynthWavetable::SAMPLES_PER_MSEC / AudioSynthWavetable::ENVELOPE_PERIOD * 0.33 + 0.5), // DECAY_COUNT
		uint32_t(139.98 * AudioSynthWavetable::SAMPLES_PER_MSEC / AudioSynthWavetable::ENVELOPE_PERIOD * 0.33 + 0.5), // RELEASE_COUNT
...
static const uint8_t Clarinet_ranges[] = {56, 70, 78, 85, 99, 127, };

const AudioSynthWavetable::instrument_data Clarinet = {6, Clarinet_ranges, Clarinet_samples };
